    ...
    return (
        <Container>
            ...
            <div className="table-row main">
                ...
                <div className="cell" style={{width:"20px"}}>Today</div>
            ...
            <div className="table-row">
                ...
                <div className="cell" style={{width:"20px"}}>1.42%</div>
                <div className="cell" style={{width:"130px"}}>548,768,200,000</div>
                <div className="cell" style={{width:"120px"}}>93% Buy</div>
            </div>
            ...
            <div className="table-row">
                ...
                <div className="cell" style={{width:"20px"}}>1.75%</div>
                <div className="cell" style={{width:"130px"}}>30,991,444,800</div>
                <div className="cell" style={{width:"120px"}}>22% Buy</div>
            </div>
            ...
            <div className="table-row">
                ...
                <div className="cell" style={{width:"20px"}}>0.15%</div>
                <div className="cell" style={{width:"130px"}}>16,408,062,100</div>
                <div className="cell" style={{width:"120px"}}>18% Buy</div>
            </div>
        </Container>
    )
}
